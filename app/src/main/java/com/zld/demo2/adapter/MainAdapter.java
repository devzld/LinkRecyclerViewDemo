...
public class MainAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MainAdapter(Context mContext, RecyclerView recyclerView, List<FoodBean> mData) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_GROUP_TITLE) {
            return new GroupViewHolder(LayoutInflater.from(mContext).inflate(R.layout.item_group, parent, false));
        } else {
            return new MainViewHolder(LayoutInflater.from(mContext).inflate(R.layout.item_main, parent, false));
        }
    }
